        ...
        <div className="flex items-center gap-3.5 select-none">
          ...
          <div className="leading-tight">
            ...
            <button
              ...
              className="mt-1 text-[10px] font-semibold uppercase tracking-wider text-zinc-500 hover:text-zinc-700 disabled:opacity-60"
            >
              {enviandoLogo ? 'Enviando logo...' : 'Editar logo'}
            </button>
            <input
              ref={inputLogoRef}
              type="file"
      ...
      <nav className="mt-4 flex items-center gap-1 overflow-x-auto rounded-2xl bg-[#F3F3F3] p-1.5">
        {navItems.map((item) => {
          ...
          const className = isActive
            ...
            : item.destaque
              ? 'flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-semibold bg-[#E16349]/10 text-[#E16349] transition-all shrink-0 hover:bg-[#E16349]/20'
