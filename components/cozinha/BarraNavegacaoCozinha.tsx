// components/cozinha/BarraNavegacaoCozinha.tsx
'use client';
...
export function BarraNavegacaoCozinha() {
  return (
    <header className="bg-white rounded-[24px] p-6 shadow-sm shadow-zinc-300/40 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
      ...
      {/* BRANDING IDENTICO AO SEU CARDÁPIO E INSUMOS */}
      ...
      <nav className="flex items-center gap-1 bg-[#F3F3F3] p-1.5 rounded-[16px] overflow-x-auto">
        ...
        <Link href="/admin/cozinha" className="flex items-center gap-1.5 px-4 py-2 rounded-[12px] text-xs font-bold bg-[#E16349] text-white shadow-sm transition-all shrink-0">
