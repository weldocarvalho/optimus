...
export default function CartaoRetirada({ endereco }: CartaoRetiradaProps) {
  const urlMapas = `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(endereco)}`;
