  ...
  return (
    <div className="grid grid-cols-1 gap-5 sm:grid-cols-3">
      ...
      <div className="bg-white rounded-[24px] p-6 border border-zinc-200/60 shadow-sm shadow-zinc-300/20 select-none">
        ...
        <h3 className="text-2xl font-black tracking-tight text-[#1A1A1A] font-mono">
      ...
      <div className="bg-white rounded-[24px] p-6 border border-zinc-200/60 shadow-sm shadow-zinc-300/20 select-none">
        ...
        <h3 className="text-2xl font-black tracking-tight text-zinc-700 font-mono mt-1">
      ...
      <div className="bg-white rounded-[24px] p-6 border border-zinc-200/60 shadow-sm shadow-zinc-300/20 select-none">
        <span className="text-[10px] font-black uppercase tracking-widest text-[#E16349] block mb-1">
          Margem de Contribuição Bruta
        </span>
        <h3 className="text-2xl font-black tracking-tight text-[#E16349] font-mono">
